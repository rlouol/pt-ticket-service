...
import com.fastcampus.pass.entity.pass.PassStatus;
...
public class ExpirePassesJobConfigTest {
    ...
    @Test
    void testExpirePassesStep() throws Exception {
        // given
        addPassEntities(10);
    ...
    private void addPassEntities(int size) {
        ...
        for(int i = 0; i < size; ++i) {
            ...
            passEntity.setStartedAt(now.minusDays(60L));
            passEntity.setEndedAt(now.minusDays(1L));
